    ...
    return (
      <button
        ...
        className={cn(
          ...
          'text-white shadow-md transition hover:bg-[#1ebe5d] hover:shadow-lg',
          className
        )}
      >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'hover:bg-[#1ebe5d] hover:shadow-lg active:scale-95',
        className
      )}
    >
...
// SVG inline → sin dependencia de librería de iconos
